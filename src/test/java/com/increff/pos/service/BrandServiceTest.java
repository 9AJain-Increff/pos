...
//import com.increff.pos.util.Assert;
...
//        BrandPojo mockBrand = Mock.getMockBrand();
...
//        BrandPojo brand = Mock.getMockBrand();
//        brandDao.addBrand(brand);
//
//        BrandPojo actual = brandService.getAndCheckBrandById(brand.getId());
//        Assert.assertEqualBrands(brand, actual);
//    }
//
//    @Test
//    @Rollback
...
//        List<BrandPojo> expected = Mock.BRANDS;
//        Assert.assertEqualList(expected, actual, Assert::assertEqualBrands);
//    }
//    @Test
//    @Rollback
...
//        Assert.assertEqualBrands(expected, actual);
//    }
//    @Test
//    @Rollback
...
//
//        BrandPojo duplicateBrand = Mock.getMockBrand();
