...
public class ProductDtoTest extends AbstractUnitTest {
    ...
    public void addProductWithUnknownBrandThrowsException() throws ApiException {
        ...
        ProductPojo expected = productDto.addProduct(productForm);
        ProductPojo actual = productService.getProductByBarcode(expected.getBarcode());
    ...
    public void testAddValidForm() throws ApiException {
        ProductForm productForm = MockUtil.getMockProductForm();
        ProductPojo expected = productDto.addProduct(productForm);
        ProductPojo actual = productService.getProductById(expected.getId());
        AssertUtil.assertEqualProducts(expected, actual);
    }
